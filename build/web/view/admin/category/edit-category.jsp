        ...
        <div class="container">
            ...
            <div class="add-content">
                ...
                <div class="add-table">
                    ...
                    <form method="post" id="ha" action="CategoryServletAction">
                        <h1 align="center">Edit Category</h1>
                        <table>
                            <tr>
                                <td>ID: </td>
                                <td><input type="text" name="id" value = "${categoryUpdate.id}" readonly="true"></td>
                            </tr>
                            <tr>
                                <td>Name: </td>
                                <td><input type="text" name="name" value = "${categoryUpdate.name}"></td>
                            </tr>
                        </table>
