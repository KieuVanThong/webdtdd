                        ...
                        <table id="table">
                            ...
                            <c:forEach items="${listUser}" var="user" >
                                <tr>
                                    ...
                                    <td>${user.username}</td>
                                    <td>${user.password}</td>
                                    <td><a href="http://localhost:8084/Smartphone/view/admin/user/UserServletEdit?userId=${user.id}"><i class="fa fa-edit"></i></a></td>
                                    <td><a href="http://localhost:8084/Smartphone/view/admin/user/UserServletRemove?userId=${user.id}"><i class="fa fa-remove"></i></a></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </div>
