...
public class ProductServletAdd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher view = request.getRequestDispatcher("/view/admin/product/add-product.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProductServletAdd.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
